...
## adding nofollow
HTML('<a href="http://spam.example.org/">viagra</a>', '<a href="http://spam.example.org/" rel="nofollow">viagra</a>',
     addnofollow=True)
HTML('<a rel="foo" href="http://spam.example.org/">viagra</a>',
     '<a href="http://spam.example.org/" rel="nofollow">viagra</a>', addnofollow=True)
